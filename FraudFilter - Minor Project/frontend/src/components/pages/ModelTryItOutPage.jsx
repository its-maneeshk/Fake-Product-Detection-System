            ...
            {activeTab === "csv" && (
              <div className="text-center">
                ...
                <input
                  id="fileInput"
                  type="file"
                  className="mx-auto block border border-gray-300 p-2 rounded bg-white backdrop-blur-md hover:border-green-500"
                ...
                {result && (
                  <div className="mt-6 bg-white p-4 rounded-lg shadow-md text-left">
                    <h2 className="text-lg font-semibold text-gray-900 mb-3">Analysis Result</h2>
                    ...
                    <p className="text-gray-700"><strong>Fake Percentage:</strong> {result.fake_percentage}%</p>
