                    ...
                    <div className="min-h-screen py-9 px-4 sm:px-6 lg:px-8">
                        <div className="max-w-6xl mx-auto">
                            ...
                            <section className="mb-12">
                                <h2 className="text-2xl font-semibold text-stone-100 mb-4">The Problem We're Solving</h2>
                            ...
                            <section className="mb-12">
                                <h2 className="text-2xl font-semibold text-stone-100 mb-4">Our Motivation</h2>
                                <p className="text-stone-300 leading-relaxed">
                            ...
                            <section className="mb-12">
                                <h2 className="text-2xl font-semibold text-stone-100 mb-4">Future Improvement and Feature addition's    <span className="inline-block text-sm font-medium text-white bg-green-400 rounded-full py-1 px-4 mt-4">
                                    Upcoming
                                </span></h2>
